$(function(){
	...
	$('.arrow_down_lang').click(function(e){
     ...
     $('.articles_slider_controls_wrapper.visible_if_less_350 > a, .return_to_main_button').click(function(){
         ...
         if($('.return_to_main_button.active').length){
             ...
             $( ".page_block_2 .page_outer_wrapper, .page_block_2 .page_inner_wrapper " ).animate({   height: "500px" }, 500, function() { });
  ...
  if ($focusElement) $($focusElement).focus();
             ...
             $( ".page_block_2 .page_outer_wrapper, .page_block_2 .page_inner_wrapper " ).animate({   height: "1630px" }, 500, function() { });
